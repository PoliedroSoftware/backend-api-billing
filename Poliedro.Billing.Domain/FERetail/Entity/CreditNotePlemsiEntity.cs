...
public class CreditNotePlemsiEntity
{
    ...
    public required InvoiceReferenceEntity invoiceReference { get; set; }

    [JsonPropertyName("discrepancy")]
    public required DiscrepancyEntity discrepancy { get; set; }
