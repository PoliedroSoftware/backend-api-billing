...
using Poliedro.Billing.Infrastructure.Persistence.Mysql.EntityFramework.EntityConfigurations;
...
public class DataBaseContext(DbContextOptions options) : DbContext(options)
{
    ...
    public DbSet<DianResolutionCreditNoteEntity> DianResolutionCreditNote { get; set; } 
    ...
    public DbSet<AuthPlemsiClient> AuthPlemsiClient { get; set; }
    ...
    private static void EntityConfiguration(ModelBuilder modelBuilder)
    {
        ...
        new AuthPlemsiClientConfiguration(modelBuilder.Entity<AuthPlemsiClient>());
