...
public class InvoicesPendingWithDetailsFERepository : IInvoicesPendingWithDetailsStrategy
{
    ...
    //        }
    //    }
    public Task<IEnumerable<CreateBilling>> GetAllInvoicePendingWithDetails(ServerEntity server, ClientEntity clientItem, IDatabaseUtils databaseUtils, CancellationToken cancellationToken, string ApiKey)
    {
